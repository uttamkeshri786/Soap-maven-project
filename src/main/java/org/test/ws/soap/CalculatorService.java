...
import org.test.ws.soap.OpType;
import org.test.ws.soap.TypeAndExpressions;
...
public class CalculatorService {
    ...
    public static void main(String[] args) {
        try
        {
            if(args != null && args.length > 0)
            {
                ...
                System.out.println("Result: "+ cal.calculate(exp.trim(), null));
    ...
    public int calculate(@WebParam(name = "expression") String expression, Map<String, Integer> map)
    {
        ...
        logger.info("Calculate method ends");
        return 0;
    }
